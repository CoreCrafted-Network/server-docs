...
In here, you are not only able to spend your time with your friends, but also meet new friends and join the community.
...
and i-survive network, hosted separately by ThisTNTSquid and jasonc123456 respectively.

As of 2014 summer, |jason| first meets ThisTNTSqud at REDCRAFT [#]_ , and started a good relationship. Afterward, they
both investigate a method for joining 2 servers together and share common server entry permissions, and share the hosting machine
...
A few months later, because failure of both server's domain caused by the domain provider, a new domain is required for
